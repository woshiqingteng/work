...
static SCB_Type *SCB = (SCB_Type *)0xE000ED00;

void UsageFault_Handler_C(unsigned int *arg)
{
...
//	SCB->SHCSR &= ~(SCB_SHCSR_USGFAULTPENDED_Msk | SCB_SHCSR_USGFAULTACT_Msk);
	
}

void SVC_Handler_C(unsigned int *arg)
{
	puts("SVC_Handler_C\n\r");
	put_s_hex("R0 = ", arg[0]);
	put_s_hex("R1 = ", arg[1]);
