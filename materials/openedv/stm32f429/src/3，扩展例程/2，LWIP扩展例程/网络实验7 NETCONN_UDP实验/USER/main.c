...
void show_address(u8 mode)
{
	...
	if(mode==2)
	{
		...
		LCD_ShowString(30,210,210,16,16,"Port:8089!"); 
	}
	else 
	{
...
{   
	...
	LCD_ShowString(30,110,200,20,16,"2016/2/29");
	...
	{
		LCD_ShowString(30,130,200,20,16,"UDP failed!   "); 		//udp创建失败
		delay_ms(500);
