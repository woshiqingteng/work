...
void show_address(u8 mode)
{
	...
	if(mode==2)
	{
		...
		LCD_ShowString(30,190,210,16,16,"Port:8087!"); 
	}
	else 
	{
...
{   
	...
	{
		LCD_ShowString(30,110,200,20,16,"TCP Client failed! "); //tcp客户端创建失败
		delay_ms(500);
		LCD_Fill(30,110,230,170,WHITE);
		delay_ms(500);
	}
    LCD_ShowString(30,110,200,20,16,"TCP Client Success!"); 	//tcp客户端创建成功
