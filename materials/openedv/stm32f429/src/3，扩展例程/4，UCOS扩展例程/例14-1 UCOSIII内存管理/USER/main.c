...
#include "sdram.h"
#include "includes.h"
//ALIENTEK 探索者STM32F429开发板 UCOSIII实验
//例14-1 UCOSIII 内存管理
...
//存储区的内存池，使用外部SRAM
__align(32) volatile CPU_INT08U External_RamMemp[EXTRENNAL_MEM_NUM][EXTERNAL_MEMBLOCK_SIZE]  __attribute__((at(0XC0800000)));	
