...
实验现象:	
	下载本例程到开发板上，默认会创建一个FRAMEWIN窗口。在FRAMWIN上有一个DROPDOWN控件和
	一个BUTTON控件，点按DROPDOWN右边的小三角打开DROPDOWN控件，选择其中某个条目。然后
	点击OK键，此时FRAMWIN窗口会消失，并且所选中的条目会显示到背景窗口上。
