...
实验目的:
	学习emWin/STemWin LISTWHEEL控件的使用。
...
实验现象:	
	下载程序到开发板，程序默认创建了一个FRAMWIN窗口，在FRAMWIN窗口上创建了五个控件，分别为
	一个LISTWHEEL控件、三个TEXT控件和一个BUTTON控件。通过LISTWHEEL控件可以调节日期，当调整
	完成以后点击OK键，此时选中的日期值就会显示到三个TEXT控件上。
