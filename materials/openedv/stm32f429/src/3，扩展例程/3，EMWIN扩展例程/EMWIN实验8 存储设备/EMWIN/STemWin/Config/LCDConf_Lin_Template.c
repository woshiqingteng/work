...
#define XSIZE_PHYS 1280     //最大支持1280*800
...
//那么每层所需要的缓冲区就是1280*800*4=4096000=0X3E8000,注意mlloc.h和malloc.c
//中的外部SDRAM内存管理池地址和大小也需要做修改！！！！
#define LCD_LAYER0_FRAME_BUFFER  ((uint32_t)0xC0000000)     //第一层缓冲区
#define LCD_LAYER1_FRAME_BUFFER  ((uint32_t)0xC0400000)     //第二层缓冲区
...
static void LCD_LL_Init(void) 
{
    ...
    LTDC_Clk_Set(320,2,RCC_PLLSAIDIVR_4); 		//设置像素时钟40Mhz 
}
