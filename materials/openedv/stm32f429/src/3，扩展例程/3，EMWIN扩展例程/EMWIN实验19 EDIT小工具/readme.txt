...
实验现象:	
	下载本例程到开发板上，默认会创建一个FRAMEWIN窗口。在FRAMWIN上有一个EDIT控件和
	一个BUTTON控件，EDIT控件上默认会有字符串“Hello Word！”，点击OK键，此时FRAMWIN	
	窗口会消失，并且EDIT控件中的字符串会显示到背景窗口上。
