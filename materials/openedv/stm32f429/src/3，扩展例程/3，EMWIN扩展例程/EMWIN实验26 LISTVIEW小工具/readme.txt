...
实验现象:	
	下载程序到开发板，程序默认创建了一个FRAMWIN窗口，在FRAMWIN窗口上创建了两个控件，分别为LISTVIEW控件和
	BUTTON控件。在LISTVIEW控件中显示了学生考试信息，当我们选中某个学生的信息以后点击OK键，FRAMEWIN控件就会
	消失，而此学生的相关信息就会显示到背景窗口上。
