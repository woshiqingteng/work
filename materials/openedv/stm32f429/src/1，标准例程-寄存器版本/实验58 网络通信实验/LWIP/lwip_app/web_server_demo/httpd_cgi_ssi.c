...
const char* LEDS_CGI_Handler(int iIndex, int iNumParams, char *pcParam[], char *pcValue[])
{
	...
	if(LED1 == 0 && beep == 1) 		return "/STM32_LED_ON_BEEP_OFF.shtml";  	//LED1开,BEEP关
	else if(LED1 == 0 && beep == 0) return "/STM32_LED_ON_BEEP_ON.shtml";		//LED1开,BEEP开
	else if(LED1 == 1 && beep == 0) return "/STM32_LED_OFF_BEEP_ON.shtml";		//LED1关,BEEP开
