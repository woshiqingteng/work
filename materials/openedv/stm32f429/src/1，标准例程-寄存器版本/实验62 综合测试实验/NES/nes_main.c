...
////////////////////////////////////////////////////////////////////////////////// 	 
//nes,音频输出支持部分
vu8 nestransferend=0;	//sai传输完成标志
vu8 neswitchbuf=0;		//saibufx指示标志
//SAI音频播放回调函数
...
int nes_sound_open(int samples_per_sync,int sample_rate) 
{
	...
	SAIA_TX_DMA_Init((u8*)saibuf1,(u8*)saibuf2,2*APU_PCMBUF_SIZE,1);//DMA配置 
